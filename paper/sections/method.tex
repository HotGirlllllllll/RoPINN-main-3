...
\subsection{Optional Curriculum Policy (Auxiliary)}
We additionally implement a two-stage curriculum (\texttt{--use\_curriculum}) as an optional policy with switch iteration
...
\end{itemize}
In this work, curriculum is treated as a secondary control variable for sensitivity analysis rather than a core innovation claim.
